...
module Vehicles
  class OptionsTest < TestCase
    ...
    def test_make_options_filter_by_continent
      refute_empty Vehicles.make_options(region: :eu)
      assert_operator Vehicles.make_options(region: :eu).size, :<=, Vehicles.make_options.size
    end
